...
//#region node_modules/react-photo-view/dist/react-photo-view.module.js
...
function p(e) {
	return (0, import_react.useReducer)(function(e, n) {
		return h({}, e, "function" == typeof n ? n(e) : n);
	}, e);
}
var w = (0, import_react.createContext)(void 0), y = "cubic-bezier(0.25, 0.8, 0.25, 1)", x = 20, C = "undefined" != typeof window && "ontouchstart" in window, b = function(e, n, t) {
	return Math.max(Math.min(e, t), n);
}, E = function(e, n, t) {
	return void 0 === n && (n = 0), void 0 === t && (t = 0), b(e, 1 * (1 - t), Math.max(6, n) * (1 + t));
}, k = "undefined" == typeof window || /ServerSideRendering/.test(navigator && navigator.userAgent) ? import_react.useEffect : import_react.useLayoutEffect;
function P(e, t, r) {
	var o = (0, import_react.useRef)(t);
	o.current = t, (0, import_react.useEffect)(function() {
		function n(e) {
			o.current(e);
		}
...
function M(n) {
	...
	return (0, import_react_dom.createPortal)(import_react.createElement("div", h({}, i)), r);
}
function Y(n) {
	return import_react.createElement("svg", h({
		width: "44",
		height: "44",
		viewBox: "0 0 768 768"
	}, n), import_react.createElement("path", { d: "M607.5 205.5l-178.5 178.5 178.5 178.5-45 45-178.5-178.5-178.5 178.5-45-45 178.5-178.5-178.5-178.5 45-45 178.5 178.5 178.5-178.5z" }));
}
function X(n) {
	return import_react.createElement("svg", h({
		width: "44",
		height: "44",
		viewBox: "0 0 768 768"
	}, n), import_react.createElement("path", { d: "M640.5 352.5v63h-390l178.5 180-45 45-256.5-256.5 256.5-256.5 45 45-178.5 180h390z" }));
}
function N(n) {
	return import_react.createElement("svg", h({
		width: "44",
		height: "44",
		viewBox: "0 0 768 768"
	}, n), import_react.createElement("path", { d: "M384 127.5l256.5 256.5-256.5 256.5-45-45 178.5-180h-390v-63h390l-178.5-180z" }));
}
function W() {
...
function I(e, t) {
	var r = t.leading, i = void 0 !== r && r, o = t.maxWait, a = t.wait, u = void 0 === a ? o || 0 : a, l = (0, import_react.useRef)(e);
	l.current = e;
	var s = (0, import_react.useRef)(0), d = (0, import_react.useRef)(), v = function() {
		return d.current && clearTimeout(d.current);
	}, f = (0, import_react.useCallback)(function() {
...
function z(n) {
	...
	return import_react.createElement("div", h({ className: "PhotoView__Spinner " + r }, i), import_react.createElement("svg", {
		viewBox: "0 0 32 32",
		width: "36",
		height: "36",
		fill: "white"
	...
	}), import_react.createElement("path", { d: "M16 0 A16 16 0 0 1 32 16 L28 16 A12 12 0 0 0 16 4z" })));
}
var j = [
	"src",
	"loaded",
...
function q(n) {
	...
	return t && !i ? import_react.createElement(import_react.Fragment, null, import_react.createElement("img", h({
		...
		onError: function() {
			s.current && a({ broken: !0 });
		},
		draggable: !1,
		alt: ""
	}, l)), !r && (c ? import_react.createElement("span", { className: "PhotoView__icon" }, c) : import_react.createElement(z, { className: "PhotoView__icon" }))) : u ? import_react.createElement("span", { className: "PhotoView__icon" }, "function" == typeof u ? u({ src: t }) : u) : null;
}
var K = {
	naturalWidth: void 0,
...
function U(t) {
	var r = t.item, o = r.src, a = r.render, c = r.width, l = void 0 === c ? 0 : c, s = r.height, d = void 0 === s ? 0 : s, v = r.originRef, f = t.visible, m = t.speed, w = t.easing, y = t.wrapClassName, x = t.className, b = t.style, _ = t.loadingElement, M = t.brokenElement, Y = t.onPhotoTap, X = t.onMaskTap, N = t.onReachMove, W = t.onReachUp, L = t.onPhotoResize, O = t.isActive, z = t.expose, j = p(K), U = j[0], G = j[1], J = (0, import_react.useRef)(0), Q = B(), Z = U.naturalWidth, $ = void 0 === Z ? l : Z, ee = U.naturalHeight, ne = void 0 === ee ? d : ee, te = U.width, re = void 0 === te ? l : te, ie = U.height, oe = void 0 === ie ? d : ie, ae = U.loaded, ce = void 0 === ae ? !o : ae, ue = U.broken, le = U.x, se = U.y, de = U.touched, ve = U.stopRaf, fe = U.maskTouched, he = U.rotate, me = U.scale, ge = U.CX, pe = U.CY, we = U.lastX, ye = U.lastY, xe = U.lastCX, Ce = U.lastCY, be = U.lastScale, Ee = U.touchTime, ke = U.touchLength, Pe = U.pause, _e = U.reach, Me = g({
		onScale: function(e) {
			return Ye(E(e));
		},
		onRotate: function(e) {
			he !== e && (z({ rotate: e }), G(h({ rotate: e }, A($, ne, e))));
		}
	});
	function Ye(e, n, t) {
		me !== e && (z({ scale: e }), G(h({ scale: e }, V(le, se, re, oe, me, e, n, t), e <= 1 && {
			x: 0,
			y: 0
		})));
	}
	var Xe = I(function(e, n, t) {
		if (void 0 === t && (t = 0), (de || fe) && O) {
			...
			if ("x" === u || fe) return void G({ reach: "x" });
	...
	function Ne(e) {
		return !ve && !de && (Q.current && G(h({}, e, { pause: f })), Q.current);
	}
	var We, Se, Te, Ve, Re, Ae, Ie, He, Le = (Re = function(e) {
		...
		return Q.current && (z({ scale: e }), G({ scale: e })), !de && Q.current;
	}, He = g({
		X: function(e) {
			return Re(e);
		},
		...
		if (x >= 200 || c !== a || Math.abs(u - a) > 1) {
			...
			null !== k && F(e, k, He.X), null !== P && F(n, P, He.Y), c !== a && F(a, c, He.S);
			return;
		}
	...
	function De(e, n) {
		if (J.current = 0, (de || fe) && O) {
			...
			if (Le(le, se, we, ye, re, oe, me, E(me, $ / re), be, he, Ee), W(e, n), ge === e && pe === n) {
	...
	P(C ? void 0 : "mousemove", function(e) {
		...
		var n = S(e);
		Xe.apply(void 0, n);
	}, { passive: !1 }), P(C ? "touchend" : void 0, function(e) {
		var n = e.changedTouches[0];
		De(n.clientX, n.clientY);
	}, { passive: !1 }), P("resize", I(function() {
		ce && !de && (G(A($, ne, he)), L());
	...
	var ze = function(e, t, r, o, a, c, l, s, d, v) {
		var f = function(e, t, r, i, o) {
			var a = (0, import_react.useRef)(!1), c = p({
				lead: !0,
				scale: r
			...
			return k(function() {
				a.current ? (o(!1), d({ lead: !0 }), v(r)) : a.current = !0;
			}, [r]), l ? [
				e * s,
				t * s,
				r / s
			...
			var c = (0, import_react.useState)(D), l = c[0], s = c[1], d = (0, import_react.useState)(0), v = d[0], f = d[1], h = (0, import_react.useRef)(), m = g({ OK: function() {
				return e && f(4);
			} });
			function p(e) {
				a(!1), f(e);
		...
		onWheel: function(e) {
			if (!_e) {
				...
				G({ stopRaf: !0 }), Ye(n, e.clientX, e.clientY);
			}
		},
		style: {
			width: ze[2] + "px",
	...
	}, o ? import_react.createElement(q, h({
		src: o,
		loaded: ce,
		broken: ue
	}, Ue, {
...
function J(r) {
	var i = r.loop, o = void 0 === i ? 3 : i, c = r.speed, l = r.easing, s = r.photoClosable, d = r.maskClosable, v = void 0 === d || d, f = r.maskOpacity, h = void 0 === f ? 1 : f, m = r.pullClosable, w = void 0 === m || m, E = r.bannerVisible, _ = void 0 === E || E, S = r.overlayRender, T = r.toolbarRender, V = r.className, R = r.maskClassName, A = r.photoClassName, I = r.photoWrapClassName, H = r.loadingElement, L = r.brokenElement, F = r.images, D = r.index, B = void 0 === D ? 0 : D, O = r.onIndexChange, z = r.visible, j = r.onClose, q = r.afterClose, K = r.portalContainer, J = p(G), Q = J[0], Z = J[1], $ = (0, import_react.useState)(0), ee = $[0], ne = $[1], te = Q.x, re = Q.touched, ie = Q.pause, oe = Q.lastCX, ae = Q.lastCY, ce = Q.bg, ue = void 0 === ce ? h : ce, le = Q.lastBg, se = Q.overlay, de = Q.minimal, ve = Q.scale, fe = Q.rotate, he = Q.onScale, me = Q.onRotate, ge = r.hasOwnProperty("index"), pe = ge ? B : ee, we = ge ? O : ne, ye = (0, import_react.useRef)(pe), xe = F.length, Ce = F[pe], be = "boolean" == typeof o ? o : xe > o, Ee = function(e, r) {
		var i = (0, import_react.useReducer)(function(e) {
			return !e;
		}, !1)[1], o = (0, import_react.useRef)(0), c = function(t) {
			var r = (0, import_react.useRef)(t);
			function i(e) {
				r.current = e;
			}
	...
	var Me = g({
		...
		changeIndex: function(e, n) {
			void 0 === n && (n = !1);
			var t = be ? ye.current + (e - pe) : e, r = xe - 1, i = b(t, 0, r), o = be ? t : i;
			Z({
				touched: !1,
				lastCX: void 0,
				lastCY: void 0,
	...
	return import_react.createElement(M, {
		...
		container: K
	}, z && import_react.createElement(W, null), import_react.createElement("div", {
		...
		onAnimationEnd: _e
	}), _ && import_react.createElement("div", { className: "PhotoView-Slider__BannerWrap" }, import_react.createElement("div", { className: "PhotoView-Slider__Counter" }, pe + 1, " / ", xe), import_react.createElement("div", { className: "PhotoView-Slider__BannerRight" }, T && Ie && T(Ie), import_react.createElement(Y, {
	...
	}), !C && _ && import_react.createElement(import_react.Fragment, null, (be || 0 !== pe) && import_react.createElement("div", {
		className: "PhotoView-Slider__ArrowLeft",
		onClick: function() {
			return Xe(pe - 1, !0);
		}
	}, import_react.createElement(X, null)), (be || pe + 1 < xe) && import_react.createElement("div", {
		className: "PhotoView-Slider__ArrowRight",
		onClick: function() {
			return Xe(pe + 1, !0);
		}
	}, import_react.createElement(N, null))), S && Ie && import_react.createElement("div", { className: "PhotoView-Slider__Overlay" }, S(Ie)));
}
var Q = [
	"children",
	"onIndexChange",
...
function $(t) {
	var r = t.children, i = t.onIndexChange, o = t.onVisibleChange, c = m(t, Q), u = p(Z), l = u[0], s = u[1], d = (0, import_react.useRef)(0), v = l.images, f = l.visible, y = l.index, x = g({
		nextId: function() {
			return d.current += 1;
		},
		update: function(e) {
		...
		close: function() {
			s({ visible: !1 }), o && o(!1, y, l);
		},
		changeIndex: function(e) {
			s({ index: e }), i && i(e, l);
		}
	}), b = (0, import_react.useMemo)(function() {
		return h({}, l, x);
	}, [l, x]);
	return import_react.createElement(w.Provider, { value: b }, r, import_react.createElement(J, h({
		images: v,
		visible: f,
		index: y,
...
var ee = function(e) {
	var t, r, o = e.src, c = e.render, u = e.overlay, f = e.width, m = e.height, p = e.triggers, y = void 0 === p ? ["onClick"] : p, x = e.children, C = (0, import_react.useContext)(w), b = (t = function() {
		return C.nextId();
	}, (r = (0, import_react.useRef)({
		sign: !1,
		fn: void 0
	}).current).sign || (r.sign = !0, r.fn = t()), r.fn), E = (0, import_react.useRef)(null);
	(0, import_react.useImperativeHandle)(null == x ? void 0 : x.ref, function() {
		return E.current;
	...
	}), P = (0, import_react.useMemo)(function() {
		var e = {};
	...
	}, [o]), x ? import_react.Children.only((0, import_react.cloneElement)(x, h({}, P, { ref: E }))) : null;
};
//#endregion
export { $ as PhotoProvider, J as PhotoSlider, ee as PhotoView };
